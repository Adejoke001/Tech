...
export default function BackendDevelopersPage() {
  ...
  const backendExpertise = [
    ...
    },
    {
      ...
      description:
        "Fault-tolerant backends for enterprise systems, IoT infrastructure, VoIP solutions, and complex applications.",
  ...
  const developmentProcess = [
    {
      ...
      description:
        "Understanding your business logic, data flow, and performance requirements.",
      icon: <FileText />,
    },
    {
      step: 2,
      ...
      description:
        "Designing scalable and secure backend architecture with technology stack selection.",
      icon: <Workflow />,
    },
    {
      step: 3,
      ...
      description:
        "Creating optimized database schemas and relationships for your application needs.",
      icon: <Database />,
    },
    {
      step: 4,
      ...
      description:
        "Building robust APIs with proper documentation and versioning strategies.",
      icon: <GitPullRequest />,
    },
    {
      step: 5,
    ...
    },
    {
      ...
      description:
        "CI/CD pipeline setup, deployment, and ongoing performance monitoring.",
      icon: <Rocket />,
    },
  ];
  ...
  const whatWeBuild = [
    {
      ...
      description:
        "Scalable payment processing, inventory management, and order fulfillment systems.",
      icon: <Globe />,
      examples: [
        "Payment gateways",
        "Inventory systems",
    ...
    },
    {
      ...
      description:
        "Secure banking systems, trading platforms, and financial analytics engines.",
      icon: <Activity />,
      examples: [
        "Banking APIs",
        "Trading engines",
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant patient management, telemedicine, and medical record systems.",
      icon: <ShieldCheck />,
      examples: [
        "Patient portals",
        "EHR systems",
    ...
    },
    {
      ...
      description:
        "Backends for connected devices, real-time data processing, and analytics.",
      icon: <Wifi />,
      examples: [
    ...
    },
    {
      ...
      description:
        "Multi-tenant architectures with subscription management and user isolation.",
      icon: <Cloud />,
      examples: [
    ...
    },
    {
      ...
      description:
        "High-performance video/audio streaming and content delivery systems.",
      icon: <DownloadCloud />,
      examples: [
        "Video streaming",
        "Content delivery",
  ...
  return (
    <div className={styles.pageWrapper}>
          ...
          >
            ...
            >
              ...
              <p className={styles.subheadline}>
                Build robust, scalable server-side systems with enterprise-grade
                performance
              </p>
      ...
      <section className={styles.expertiseSection} id="expertise">
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Expertise of Our{" "}
            <span className={styles.titleHighlight}>Backend Developers</span>
          </h2>
          <p className={styles.sectionDescription}>
            We have a team of experienced backend development experts who can
            help you get started with development from scratch or take your
      ...
      <section className={styles.techStackSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Technology Stack of Our{" "}
            <span className={styles.titleHighlight}>Backend Developers</span>
          </h2>
          <p className={styles.sectionDescription}>
            Our talented backend developers have expertise in various
            technologies and tools. We can help you with backend development
            using any technology you may need.
          </p>
        </div>
      ...
      <section className={styles.qualitySection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            How We Ensure{" "}
            <span className={styles.titleHighlight}>Code Quality</span>
          </h2>
          <p className={styles.sectionDescription}>
            At the core of our development process, we prioritize code quality,
            implementing stringent testing, detailed reviews, and industry-best
            practices to deliver software that excels in both functionality and
            longevity.
          </p>
        </div>
      ...
      <section className={styles.processSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            A structured approach to delivering high-quality backend solutions
      ...
      <section className={styles.buildSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            What Our Backend Experts{" "}
            <span className={styles.titleHighlight}>Can Build</span>
          </h2>
          <p className={styles.sectionDescription}>
            From enterprise systems to real-time applications, we deliver robust
      ...
      <section className={styles.comparisonSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            When it comes to building backend systems, you have three main
            options. Let&apos;s take a look at each in detail.
          </p>
        </div>
        ...
        <div className={styles.ctaSection}>
          <div className={styles.ctaContent}>
            <h3 className={styles.ctaTitle}>
              Need Secure, High-Performance Backend Systems?
            </h3>
            <p className={styles.ctaDescription}>
              Hire backend developers who build robust, scalable server-side
              architecture that powers your business growth with
