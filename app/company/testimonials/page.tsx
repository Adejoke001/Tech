...
export default function TestimonialsPage() {
    ...
    const testimonials = [
        {
            id: 1,
            quote: "Huge thank you to BBNTech; they have been a massive help in enabling us to start developing our project within a few weeks, so it's been great! There have been two small bumps in the road, but overall, It's been a fantastic service. I have already recommended it to one of my friends.",
            name: 'Mohammed Mirza',
        ...
        {
            id: 2,
            quote: "BBNTech is our go-to partner to help us realize our software needs; they are supportive, friendly, and always ready to help us when we face difficulties in the project. 10/10 would recommend.",
            name: 'Michelle Fno',
        ...
        {
            id: 3,
            quote: "BBNTech had great technical expertise, both in front-end and back-end development. Other project management was well organized. Account management was friendly and always available. I would give BBNTech ten out of ten!",
            name: 'Kris Bruynson',
        ...
        {
            id: 6,
            quote: "We have been working with BBNTech for the last year now and have deployed multiple developers at different points in time. We are really happy with the support we get from BBNTech and the resources they provide.",
        ...
        {
            id: 8,
            quote: "We have worked with BBNTech for more than a year, and their skilled team has allowed us to scale up during certain projects, thereby allowing our full-time team to focus on core platform functionality. Recommended.",
            name: 'Adam Watts',
        ...
        {
            id: 10,
            quote: "BBNTech has accelerated our project and brought a talented developer to our team. We worked with a back-end coder with many years of experience that understood integrations, business strategy and brought new ideas to the table that boosted our UI/UX. I highly recommend connecting with BBNTech and meeting their team, interviewing a couple of coders, and picking the best one for your project. Thank you for the great work over the last several months!",
            name: 'Michelle Fno',
        ...
        {
            id: 11,
            quote: "We got an awesome product! I would highly recommend BBNTech to anyone for their professional attitude & customer care. Hope success to them!",
            name: 'Mr. Savarni',
        ...
        {
            id: 12,
            quote: "We had the opportunity to work with BBNTech on our website development. They demonstrated a very good understanding of the work scope, and assembled the team quickly. Challenges are a part of any development process, but BBNTech tackled them in the right way, and involved their experts in the process. They approached each problem with professionalism and creativity, ensuring the project remained on track without compromising on quality. BBNTech has met our expectations. Their dedication, expertise, and commitment to our project were evident throughout the process. I would recommend BBNTech to anyone in need of improving or developing software product. This might have been our first project with them, but it won't be our last.",
            name: 'Mohammad Bdair',
        ...
        {
            id: 14,
            quote: "I wanted to take a moment to appreciate the incredible work BBNTech' team has done in creating the ORA wireframe. It is evident that a lot of thought, creativity, and precision have gone into this work, and it truly reflects in team's dedication and skill. The wireframe not only meets but exceeds our expectations, and we are deeply grateful for the contribution.",
            name: 'ORA Team',
        ...
        {
            id: 15,
            quote: "We outsourced our website development and coding to BBNTech, and we are super happy with their services. We'd recommend them for any website development service for business development.",
            name: 'Jame Thompson',
        ...
        {
            id: 17,
            quote: "I can't praise the development team at BBNTech enough! They tackled every challenge I threw their way with ease. Their dedication and ability to think outside the box exceeded my expectations. Communication was excellent, with regular updates and quick responses to my queries. Their problem-solving skills and commitment to our success were remarkable. I highly recommend BBNTech as a development partner.",
            name: 'Akshay',
            role: 'SD Advisors',
            hasVideo: false,
        },
        {
            id: 18,
            quote: "BBNTech is a very professional development team. I used their expertise in the building of an online comparison tool. We defined a clear scope, and the team designed mock-ups first. With the help of online project tools and Skype Q&A sessions, you can really work together despite the great geographical distance. I would highly recommend the services of BBNTech as they go the extra mile to deliver a good product.",
        ...
        {
            id: 19,
            quote: "We have been working with BBNTech since the start of 2020. After using BBNTech for one project, we decided to outsource our entire development team to BBNTech. We really like the flexibility and different skills that BBNTech offers. We can quickly scale up and down as required. Since outsourcing to BBNTech, our productivity has substantially increased. I appreciate the way that we have been able to outsource to BBNTech but still maintain direct communications with the developers and control over their work. Thank you, BBNTech!",
            name: 'Karl Turnbull',
        ...
        {
            id: 20,
            quote: "We’ve been very pleased with the services provided by BBNTech. Team members are prompt, kind, and deliver fantastic work. The new invoice styles have been great and help us to stay more organized. It’s been a reliable system for our team!",
            name: 'Daymoon Team',
            role: '',
            hasVideo: false,
        },
