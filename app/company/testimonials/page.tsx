...
export default function TestimonialsPage() {
    ...
    const testimonials = [
        {
            id: 1,
            quote: "Huge thank you to ValueCoders; they have been a massive help in enabling us to start developing our project within a few weeks, so it's been great! There have been two small bumps in the road, but overall, It's been a fantastic service. I have already recommended it to one of my friends.",
            name: 'Mohammed Mirza',
        ...
        {
            id: 2,
            quote: "ValueCoders is our go-to partner to help us realize our software needs; they are supportive, friendly, and always ready to help us when we face difficulties in the project. 10/10 would recommend.",
            name: 'Michelle Fno',
        ...
        {
            id: 3,
            quote: "ValueCoders had great technical expertise, both in front-end and back-end development. Other project management was well organized. Account management was friendly and always available. I would give ValueCoders ten out of ten!",
            name: 'Kris Bruynson',
        ...
        {
            id: 6,
            quote: "We have been working with ValueCoders for the last year now and have deployed multiple developers at different points in time. We are really happy with the support we get from ValueCoders and the resources they provide.",
        ...
        {
            id: 8,
            quote: "We have worked with ValueCoders for more than a year, and their skilled team has allowed us to scale up during certain projects, thereby allowing our full-time team to focus on core platform functionality. Recommended.",
            name: 'Adam Watts',
        ...
        {
            id: 11,
            quote: "We got an awesome product! I would highly recommend ValueCoders to anyone for their professional attitude & customer care. Hope success to them!",
            name: 'Mr. Savarni',
        ...
        {
            id: 12,
            quote: "We had the opportunity to work with Valuecoders on our website development. They demonstrated a very good understanding of the work scope, and assembled the team quickly. Challenges are a part of any development process, but Valuecoders tackled them in the right way, and involved their experts in the process. They approached each problem with professionalism and creativity, ensuring the project remained on track without compromising on quality. Valuecoders has met our expectations. Their dedication, expertise, and commitment to our project were evident throughout the process. I would recommend Valuecoders to anyone in need of improving or developing software product. This might have been our first project with them, but it won't be our last.",
            name: 'Mohammad Bdair',
        ...
        {
            id: 14,
            quote: "I wanted to take a moment to appreciate the incredible work ValueCoders' team has done in creating the ORA wireframe. It is evident that a lot of thought, creativity, and precision have gone into this work, and it truly reflects in team's dedication and skill. The wireframe not only meets but exceeds our expectations, and we are deeply grateful for the contribution.",
            name: 'ORA Team',
        ...
        {
            id: 15,
            quote: "We outsourced our website development and coding to ValueCoders, and we are super happy with their services. We'd recommend them for any website development service for business development.",
            name: 'Jame Thompson',
        ...
        {
            id: 20,
            quote: "We’ve been very pleased with the services provided by ValueCoders. Team members are prompt, kind, and deliver fantastic work. The new invoice styles have been great and help us to stay more organized. It’s been a reliable system for our team!",
            name: 'Daymoon Team',
            role: '',
            hasVideo: false,
        },
