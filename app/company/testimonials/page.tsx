...
export default function TestimonialsPage() {
    ...
    const testimonials = [
        ...
        {
            id: 9,
            quote: "The team at BBMTech really has provided us with exceptional services in creating this one-of-a-kind portal, and it has been a fantastic experience. I was particularly impressed how efficiently and quickly the team always came up with creative solutions to provide us with all the functionalities within the portal we had requested.",
            name: 'Judith Muet',
