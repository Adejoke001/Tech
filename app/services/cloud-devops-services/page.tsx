                ...
                <div className={styles.heroContent}>
                    <motion.div className={styles.heroText} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <p className={styles.heroDescription}>
                            Future-ready businesses run on cloud. At BBMcoders, we help you modernize, migrate, manage, and scale your cloud environments while ensuring your business stays agile, compliant, and cost-optimized.
                        </p>
