...
export default function QAStrategyConsultingPage() {
  ...
  const qaServices = [
    {
      ...
      description:
        "Get your robust QA process setup: Analyze your software specifics, design testing strategy, estimate time and costs.",
    ...
    },
    {
      ...
      description:
        "Get valuable insights with complete QA audit: Examine current processes, reveal bottlenecks, recommend improvements.",
    ...
    },
    {
      ...
      description:
        "Enhance your QA process with tailored consulting: Identify problems, work out mitigation strategies, implement improvements.",
    ...
    },
    {
      ...
      description:
        "Assist in success with pre-certification QA support: Outline required certifications, advise on improvements, create compliance roadmap.",
    ...
    },
    {
      ...
      description:
        "Accelerate testing with our automation expertise: Design automation strategy, setup test data generation, integrate into CI/CD.",
    ...
    },
    {
      ...
      description:
        "Tailored testing strategies for every software type: Design effective scenarios, assess automation feasibility.",
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description:
        "End-to-end QA solutions from initial strategy to final implementation.",
    ...
    <div className={styles.pageWrapper}>
        ...
        <div className={styles.heroContent}>
          ...
          >
            ...
            <h1 className={styles.heroTitle}>
              Transform Quality with{" "}
              <span className={styles.gradientText}>Expert QA Consulting</span>
            </h1>

            <p className={styles.heroDescription}>
              Optimize your software quality with expert QA consulting. We
              design tailored QA processes or enhance existing ones to improve
              performance, ensure compliance, and deliver reliable outcomes.
            </p>
      ...
      <section className={styles.benefitsBanner}>
        <div className={styles.benefitsContent}>
          <h2 className={styles.benefitsTitle}>
            Achieve a{" "}
            <span className={styles.benefitsHighlight}>
              95% Reduction in Bugs
            </span>
          </h2>
          <p className={styles.benefitsDescription}>
            We build a robust quality framework that catches defects at the
            source, ensuring your final product is nearly flawless.
          </p>
      ...
      <section className={styles.servicesSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Our <span className={styles.titleHighlight}>QA Consulting</span>{" "}
            Services
          </h2>
      ...
      <section className={styles.processSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            We specialize in engineering custom software that&apos;s both stable
            and secure, using a structured agile approach.
          </p>
        </div>
      ...
      <section className={styles.whyChooseSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescriptionWhite}>
            With 20+ years of experience, we help companies evaluate and improve
            QA processes, introduce smart testing, and design robust QA
        ...
        <div className={styles.whyChooseGrid}>
          {whyChooseUs.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
            >
              <div className={styles.chooseIconWrapper}>{item.icon}</div>
      ...
      <section className={styles.industriesSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            ...
            for growth, innovation, and quality excellence.
          </p>
        </div>
      ...
      <section id="pricing" className={styles.pricingSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            Every QA engagement is different, shaped by your testing needs,
            project scale, and required expertise.
          </p>
        </div>
      ...
      <section className={styles.faqSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            Find answers to common questions about our QA consulting services
            and solutions.
          </p>
        </div>
        ...
        <div className={styles.ctaSection}>
          <div className={styles.ctaContent}>
            <h3 className={styles.ctaTitle}>
              Ready to Transform Your QA Processes?
            </h3>
            <p className={styles.ctaDescription}>
              Your quality vision is our next project. Tell us about your
              quality goals, and we&apos;ll show you exactly how to make them a
