  ...
  const industrySolutions = [
    {
      industry: "FinTech",
      challenges:
        "High security requirements, regulatory compliance, transaction accuracy",
      solutions: [
    ...
    },
    {
      industry: "E-commerce",
      challenges:
        "High traffic handling, payment gateway integration, mobile optimization",
      solutions: [
  ...
  const faqs = [
    {
      ...
      answer:
        "Quality Assurance (QA) is the overall process of ensuring quality in software development, including processes, standards, and methodologies. Testing is a subset of QA focused on executing software to identify defects.",
    },
    {
      question: "How long does a typical QA project take?",
      answer:
        "The duration depends on project complexity, scope, and testing requirements. Typically, QA projects range from 2-8 weeks for standard applications. Complex enterprise systems may require 12+ weeks.",
    },
    {
      question: "What testing tools do you use?",
      answer:
        "We use a comprehensive toolset including Selenium, Cypress, Playwright for automation; JMeter, LoadRunner for performance; OWASP ZAP for security; Appium for mobile; and TestRail, JIRA for test management.",
    },
  ];
    ...
    <div className={styles.pageWrapper}>
          ...
          >
            ...
            >
              <h1 className={styles.mainTitle}>
                Quality Assurance &{" "}
                <span className={styles.highlight}>Testing</span> Services
              </h1>
              <p className={styles.subheadline}>
                Deliver flawless software with our comprehensive QA and testing
                solutions. From manual testing to advanced automation, we ensure
                your applications are robust, secure, and user-ready.
              </p>
            </motion.div>
      ...
      <section className={styles.servicesSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Comprehensive{" "}
            <span className={styles.titleHighlight}>QA Services</span>
          </h2>
          <p className={styles.sectionDescription}>
            We provide end-to-end quality assurance services to ensure your
            software meets the highest standards of performance, security, and
            user experience.
          </p>
        </div>
      ...
      <section className={styles.processSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            A structured approach to quality assurance that ensures
            comprehensive testing and timely delivery.
          </p>
        </div>
        ...
        <div className={styles.processContainer}>
          {qaProcess.map((process) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className={styles.processNumber}>Step {process.step}</div>
      ...
      <section className={styles.industrySection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Industry-Specific{" "}
            <span className={styles.titleHighlight}>Solutions</span>
          </h2>
          <p className={styles.sectionDescription}>
            Tailored QA strategies for different industries with unique
            ...
            >
              <div className={styles.industryHeader}>
                ...
                <div className={styles.challenges}>
                  <span className={styles.challengesLabel}>
                    Key Challenges:
                  </span>
              ...
              <div className={styles.buttonWrapper}>
                <Link
                  href={
                    industry.link || `/industries/${slugify(industry.industry)}`
                  }
      ...
      <section className={styles.faqSection}>
        ...
        <div className={styles.ctaSection}>
          ...
          <p className={styles.ctaDescription}>
            Let&apos;s discuss your testing requirements and create a customized
            QA strategy.
          </p>
