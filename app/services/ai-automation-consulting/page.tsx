  ...
  const aiTechnologies = [
    {
      ...
      color: "#60a6fb",
      description:
        "Advanced frameworks for building, training, and deploying machine learning models.",
    },
    {
      ...
      color: "#34d399",
      description:
        "Managed cloud services for end-to-end AI workflow management and scaling.",
    },
    {
      ...
      color: "#8b5cf6",
      description:
        "Tools for big data processing, real-time analytics, and data pipeline orchestration.",
    },
    {
      ...
      color: "#f59e0b",
      description:
        "Platforms for model versioning, monitoring, and scalable production deployment.",
    },
    {
      ...
      color: "#ef4444",
      description:
        "Cutting-edge tools for text generation, conversational AI, and content creation.",
    },
    {
      ...
      color: "#06b6d4",
      description:
        "Interactive dashboards and business intelligence tools for AI insights.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description:
        "Comprehensive analysis of your business needs, challenges, and AI readiness.",
    ...
    },
    {
      ...
      description:
        "Creating tailored AI roadmap aligned with your business objectives.",
    ...
    },
    {
      ...
      description:
        "Architecting custom AI solutions with technology-neutral approach.",
    ...
    },
    {
      ...
      description:
        "Rigorous testing, validation, and performance optimization.",
    ...
    },
    {
      ...
      description:
        "Knowledge transfer and ongoing support for continuous improvement.",
  ...
  const faqs = [
    {
      ...
      answer:
        "AI consulting helps businesses harness artificial intelligence effectively through expert guidance, customized strategies, and implementation support. Benefits include improved decision-making, increased efficiency, accelerated implementation, risk mitigation, and gaining a competitive edge through innovative AI solutions.",
    },
    {
      question: "How do you maintain technology neutrality in AI consulting?",
      answer:
        "We maintain technology neutrality through thorough assessment of your needs, extensive market research, pilot projects for testing, objective performance metrics, vendor-agnostic recommendations, transparent communication, and collaborative decision-making focused solely on your business objectives.",
    },
    {
      question:
        "What are the common risks in AI integration and how do you mitigate them?",
      answer:
        "Common risks include data quality issues, bias in AI models, lack of expertise, scalability challenges, ROI uncertainty, and system interoperability. We mitigate these through robust data governance, bias detection techniques, knowledge transfer, scalable architecture design, thorough cost-benefit analysis, and careful integration planning.",
    },
    {
      question: "What industries benefit most from AI consulting services?",
      answer:
        "Healthcare, Fintech, Retail, Manufacturing, Education, and Media & Entertainment benefit significantly. Each industry has unique applications like AI diagnostics in healthcare, fraud detection in banking, demand forecasting in retail, predictive maintenance in manufacturing, adaptive learning in education, and content personalization in media.",
    },
    {
      question: "How long does a typical AI consulting engagement take?",
      answer:
        "Engagement timelines vary: Initial assessments take 2-4 weeks, strategy development 4-6 weeks, pilot projects 8-12 weeks, and full implementations 3-6 months. We provide detailed timelines during initial assessment based on your specific requirements and AI readiness.",
    },
    {
      question:
        "What is the long-term value of AI consulting for business growth?",
      answer:
        "AI consulting provides long-term value by identifying innovation opportunities, creating competitive advantages, optimizing operations, enabling scalability, future-proofing technology investments, and driving sustainable business growth through continuous AI innovation and adaptation.",
    },
  ];
    ...
    <div className={styles.pageWrapper}>
        ...
        <div className={styles.heroContent}>
          ...
          >
            ...
            <p className={styles.heroDescription}>
              Integrate AI-driven solutions across your organization with our
              complete consulting services. We connect technical challenges with
              strategic goals through an outcome-driven approach.
            </p>
      ...
      <section className={styles.benefitsBanner}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            Combining our deep industry knowledge with cutting-edge AI
            technologies, we offer comprehensive AI consulting to guide
            businesses in using the full potential of artificial intelligence.
          </p>
        </div>
                  ...
                  <AnimatePresence>
                    {hoveredService === service.id && (
                      <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        <p className={styles.serviceExcerpt}>
                          {service.description}
                        </p>
        ...
        <div className={styles.technologiesContent}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitleWhite}>
              AI Technologies{" "}
              <span className={styles.titleHighlightWhite}>We Master</span>
            </h2>
            <p className={styles.sectionDescriptionWhite}>
              We maintain technology neutrality while leveraging cutting-edge AI
              frameworks, tools, and platforms to build robust, scalable, and
              future-proof AI solutions for your business.
            </p>
          </div>
      ...
      <section className={styles.whyChooseSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            Our AI consultants and development experts are committed to
            providing you with AI consulting services tailored to your specific
        ...
        <div className={styles.whyChooseGrid}>
          {whyChooseUs.map((item, index) => (
            ...
            >
              <div
                className={styles.chooseIconWrapper}
      ...
      <section className={styles.industriesSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Industries We{" "}
            <span className={styles.titleHighlight}>Cater To</span>
          </h2>
          <p className={styles.sectionDescription}>
            Partnering with businesses in diverse sectors to unlock new avenues
            for growth, innovation, and competitive advantage through AI-powered
            transformation.
          </p>
        </div>
          ...
          {industries.map((industry) => (
            ...
            >
              <div className={styles.industryImageContainer}>
                ...
                />
                <div
                  className={`${styles.industryOverlay} ${activeIndustry === industry.id ? styles.active : ""}`}
                ></div>

                {/* Always visible header */}
                <div className={styles.industryHeader}>
                  <div className={styles.industryEmoji}>{industry.icon}</div>
                  <h3 className={styles.industryNameOverlay}>
                    {industry.name}
                  </h3>
                </div>
              </div>
              ...
              <div className={styles.industryContent}>
                    ...
                    >
                      <div className={styles.solutionsPreview}>
                        {industry.solutions.slice(0, 2).map((solution, idx) => (
                          <span
                            key={idx}
                            className={styles.solutionPreview}
                ...
                <Link
                  href={
                    industry.link || `/industries/${slugify(industry.name)}`
                  }
      ...
      <section className={styles.processSection}>
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionDescription}>
            We specialize in engineering custom AI solutions that are both
            powerful and secure, using a structured, agile approach tailored to
            your business needs.
          </p>
        </div>
        ...
        <div className={styles.processTimeline}>
          {processSteps.map((step, index) => (
            ...
            >
              ...
              <div className={styles.processIconWrapper}>{step.icon}</div>
      ...
      <section className={styles.hiringSection}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            Flexible{" "}
            <span className={styles.titleHighlight}>Hiring Models</span>
          </h2>
          <p className={styles.sectionDescription}>
            Choose from our flexible hiring models designed to fit your specific
            needs, budget, and project requirements for AI consulting.
          </p>
        </div>
        ...
        <div className={styles.ctaSection}>
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaDescription}>
              Your AI vision is our next project. Tell us about your business
              goals, and we&apos;ll show you exactly how AI can make them a
              reality.
            </p>
