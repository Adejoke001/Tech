...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    ourExpertise: [
      { name: 'Software Product Engineering', href: '/expertise/product-engineering' },
      { name: 'Application Development', href: '/expertise/application-development' },
    ...
    hireDevelopers: [
      ...
      { name: 'Hire Blockchain Developers', href: '/hire/blockchain-developers' },
